...
void ui_Mainwindow::setupUi(QMainWindow *MainWindow)
{
    ...
    widget->setGeometry(QRect(11, 11, 589, 50));//x,y,width,height
    ...
    widget_6->setGeometry(QRect(11, 394, 589, 50));
    widget_6->setMaximumSize(QSize(16777215, 50));
    horizontalLayout_3 = new QHBoxLayout(widget_6);
    horizontalLayout_3->setSpacing(0);
    horizontalLayout_3->setObjectName(QStringLiteral("horizontalLayout_3"));
    horizontalLayout_3->setContentsMargins(0, 0, 0, 0);
    horizontalSpacer_6 = new QSpacerItem(15, 60, QSizePolicy::Fixed, QSizePolicy::Minimum);
    ...
    horizontalSpacer_7 = new QSpacerItem(15, 50, QSizePolicy::Fixed, QSizePolicy::Minimum);
    ...
    widget_7->setGeometry(QRect(11, 367, 586, 40));
