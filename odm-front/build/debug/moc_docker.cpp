...
QT_MOC_LITERAL(4, 30, 11) // "littleImage"

    },
    "Docker\0dockerRun\0\0resultReady\0littleImage"
};
...
void Docker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Docker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Docker::littleImage)) {
                *result = 2;
                return;
            }
        }
